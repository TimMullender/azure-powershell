...
namespace Wandisco.Fusion.Support
{
    ...
    {
        public static Wandisco.Fusion.Support.ResourceIdentityType None = @"None";

        public static Wandisco.Fusion.Support.ResourceIdentityType UserAssigned = @"UserAssigned";
        ...
        public bool Equals(Wandisco.Fusion.Support.ResourceIdentityType e)
        {
        ...
        public static implicit operator string(Wandisco.Fusion.Support.ResourceIdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Wandisco.Fusion.Support.ResourceIdentityType e1, Wandisco.Fusion.Support.ResourceIdentityType e2)
        {
            return !e2.Equals(e1);
        }
