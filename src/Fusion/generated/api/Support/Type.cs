...
namespace Wandisco.Fusion.Support
{
    ...
    {
        public static Wandisco.Fusion.Support.Type Blocking = @"Blocking";

        public static Wandisco.Fusion.Support.Type NonBlocking = @"NonBlocking";
        ...
        public bool Equals(Wandisco.Fusion.Support.Type e)
        {
        ...
        public static implicit operator string(Wandisco.Fusion.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Wandisco.Fusion.Support.Type e1, Wandisco.Fusion.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
