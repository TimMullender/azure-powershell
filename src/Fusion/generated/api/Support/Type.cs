...
namespace Sample.API.Support
{
    ...
    {
        public static Sample.API.Support.Type Blocking = @"Blocking";

        public static Sample.API.Support.Type NonBlocking = @"NonBlocking";
        ...
        public bool Equals(Sample.API.Support.Type e)
        {
        ...
        public static implicit operator string(Sample.API.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Sample.API.Support.Type e1, Sample.API.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
