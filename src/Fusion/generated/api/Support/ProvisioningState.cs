...
namespace Wandisco.Fusion.Support
{
    ...
    {
        public static Wandisco.Fusion.Support.ProvisioningState Accepted = @"Accepted";

        public static Wandisco.Fusion.Support.ProvisioningState Deleted = @"Deleted";

        public static Wandisco.Fusion.Support.ProvisioningState Deleting = @"Deleting";

        public static Wandisco.Fusion.Support.ProvisioningState Failed = @"Failed";

        public static Wandisco.Fusion.Support.ProvisioningState NotSpecified = @"NotSpecified";

        public static Wandisco.Fusion.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Wandisco.Fusion.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Wandisco.Fusion.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Wandisco.Fusion.Support.ProvisioningState e1, Wandisco.Fusion.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
