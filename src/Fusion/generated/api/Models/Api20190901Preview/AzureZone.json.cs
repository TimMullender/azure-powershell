namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class AzureZone
    {
        ...
        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="AzureZone" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AzureZone(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_properties = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Wandisco.Fusion.Models.Api20190901Preview.AzureZoneProperties.FromJson(__jsonProperties) : Properties;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureZone.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureZone.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IAzureZone FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new AzureZone(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureZone" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureZone" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
