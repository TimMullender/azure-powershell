namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class LiveHiveFusionServer
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.ILiveHiveFusionServer.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.ILiveHiveFusionServer.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.ILiveHiveFusionServer FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new LiveHiveFusionServer(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="LiveHiveFusionServer" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal LiveHiveFusionServer(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_hiveMetastore = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonString>("hiveMetastore"), out var __jsonHiveMetastore) ? (string)__jsonHiveMetastore : (string)HiveMetastore;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LiveHiveFusionServer" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LiveHiveFusionServer" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._hiveMetastore)?.ToString()) ? (Wandisco.Fusion.Runtime.Json.JsonNode) new Wandisco.Fusion.Runtime.Json.JsonString(this._hiveMetastore.ToString()) : null, "hiveMetastore" ,container.Add );
