namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class AzureNodeDetails
    {
        ...
        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="AzureNodeDetails" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AzureNodeDetails(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            __nodeDetails = new Wandisco.Fusion.Models.Api20190901Preview.NodeDetails(json);
            {_vM = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("vm"), out var __jsonVM) ? Wandisco.Fusion.Models.Api20190901Preview.AzureNodeDetailsVM.FromJson(__jsonVM) : VM;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureNodeDetails.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureNodeDetails.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IAzureNodeDetails FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new AzureNodeDetails(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureNodeDetails" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureNodeDetails" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            __nodeDetails?.ToJson(container, serializationMode);
            AddIf( null != this._vM ? (Wandisco.Fusion.Runtime.Json.JsonNode) this._vM.ToJson(null,serializationMode) : null, "vm" ,container.Add );
