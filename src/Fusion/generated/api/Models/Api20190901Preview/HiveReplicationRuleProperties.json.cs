namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class HiveReplicationRuleProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRuleProperties.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRuleProperties.
        /// </returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRuleProperties FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new HiveReplicationRuleProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="HiveReplicationRuleProperties" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal HiveReplicationRuleProperties(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_recentConsistencyReport = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("recentConsistencyReport"), out var __jsonRecentConsistencyReport) ? Wandisco.Fusion.Models.Api20190901Preview.HiveConsistencyReport.FromJson(__jsonRecentConsistencyReport) : RecentConsistencyReport;}
            {_dbNamePattern = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonString>("dbNamePattern"), out var __jsonDbNamePattern) ? (string)__jsonDbNamePattern : (string)DbNamePattern;}
            ...
            {_tableNamePattern = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonString>("tableNamePattern"), out var __jsonTableNamePattern) ? (string)__jsonTableNamePattern : (string)TableNamePattern;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="HiveReplicationRuleProperties" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="HiveReplicationRuleProperties" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._dbNamePattern)?.ToString()) ? (Wandisco.Fusion.Runtime.Json.JsonNode) new Wandisco.Fusion.Runtime.Json.JsonString(this._dbNamePattern.ToString()) : null, "dbNamePattern" ,container.Add );
            if (serializationMode.HasFlag(Wandisco.Fusion.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != (((object)this._tableNamePattern)?.ToString()) ? (Wandisco.Fusion.Runtime.Json.JsonNode) new Wandisco.Fusion.Runtime.Json.JsonString(this._tableNamePattern.ToString()) : null, "tableNamePattern" ,container.Add );
