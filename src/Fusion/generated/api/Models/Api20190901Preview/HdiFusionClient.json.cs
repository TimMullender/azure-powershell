namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class HdiFusionClient
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IHdiFusionClient.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IHdiFusionClient.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IHdiFusionClient FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new HdiFusionClient(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="HdiFusionClient" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal HdiFusionClient(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_hdiClusterId = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonString>("hdiClusterId"), out var __jsonHdiClusterId) ? (string)__jsonHdiClusterId : (string)HdiClusterId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="HdiFusionClient" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="HdiFusionClient" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._hdiClusterId)?.ToString()) ? (Wandisco.Fusion.Runtime.Json.JsonNode) new Wandisco.Fusion.Runtime.Json.JsonString(this._hdiClusterId.ToString()) : null, "hdiClusterId" ,container.Add );
