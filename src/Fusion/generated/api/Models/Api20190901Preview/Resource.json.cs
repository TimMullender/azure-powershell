namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class Resource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IResource.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IResource.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IResource FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new Resource(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="Resource" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Resource(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_location = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonString>("location"), out var __jsonLocation) ? (string)__jsonLocation : (string)Location;}
            {_tags = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Wandisco.Fusion.Models.Api20190901Preview.ResourceTags.FromJson(__jsonTags) : Tags;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Resource" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Resource" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._location)?.ToString()) ? (Wandisco.Fusion.Runtime.Json.JsonNode) new Wandisco.Fusion.Runtime.Json.JsonString(this._location.ToString()) : null, "location" ,container.Add );
            AddIf( null != this._tags ? (Wandisco.Fusion.Runtime.Json.JsonNode) this._tags.ToJson(null,serializationMode) : null, "tags" ,container.Add );
