namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class ConsistencyCheckOptionsProperties
    {
        ...
        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="ConsistencyCheckOptionsProperties" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ConsistencyCheckOptionsProperties(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_nonBlockingThreshold = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonNumber>("nonBlockingThreshold"), out var __jsonNonBlockingThreshold) ? (int?)__jsonNonBlockingThreshold : NonBlockingThreshold;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IConsistencyCheckOptionsProperties.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Wandisco.Fusion.Models.Api20190901Preview.IConsistencyCheckOptionsProperties.
        /// </returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IConsistencyCheckOptionsProperties FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new ConsistencyCheckOptionsProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConsistencyCheckOptionsProperties" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConsistencyCheckOptionsProperties" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._nonBlockingThreshold ? (Wandisco.Fusion.Runtime.Json.JsonNode)new Wandisco.Fusion.Runtime.Json.JsonNumber((int)this._nonBlockingThreshold) : null, "nonBlockingThreshold" ,container.Add );
