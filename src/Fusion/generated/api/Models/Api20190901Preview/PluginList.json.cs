namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class PluginList
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IPluginList.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IPluginList.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IPluginList FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new PluginList(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="PluginList" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PluginList(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as Wandisco.Fusion.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Wandisco.Fusion.Models.Api20190901Preview.IPlugin[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Wandisco.Fusion.Models.Api20190901Preview.IPlugin) (Wandisco.Fusion.Models.Api20190901Preview.Plugin.FromJson(__u) )) ))() : null : Value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PluginList" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PluginList" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
