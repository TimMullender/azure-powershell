namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class AzureNodeDetailsVM
    {
        ...
        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="AzureNodeDetailsVM" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AzureNodeDetailsVM(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureNodeDetailsVM.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureNodeDetailsVM.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IAzureNodeDetailsVM FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new AzureNodeDetailsVM(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureNodeDetailsVM" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureNodeDetailsVM" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
