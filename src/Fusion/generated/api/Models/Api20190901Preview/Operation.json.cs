namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class Operation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IOperation.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IOperation.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IOperation FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new Operation(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="Operation" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Operation(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_display = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("display"), out var __jsonDisplay) ? Wandisco.Fusion.Models.Api20190901Preview.OperationDisplay.FromJson(__jsonDisplay) : Display;}
            {_name = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonString>("name"), out var __jsonName) ? (string)__jsonName : (string)Name;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Operation" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Operation" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._display ? (Wandisco.Fusion.Runtime.Json.JsonNode) this._display.ToJson(null,serializationMode) : null, "display" ,container.Add );
