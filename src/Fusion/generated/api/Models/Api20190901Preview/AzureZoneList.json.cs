namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class AzureZoneList
    {
        ...
        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="AzureZoneList" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AzureZoneList(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as Wandisco.Fusion.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Wandisco.Fusion.Models.Api20190901Preview.IAzureZone[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Wandisco.Fusion.Models.Api20190901Preview.IAzureZone) (Wandisco.Fusion.Models.Api20190901Preview.AzureZone.FromJson(__u) )) ))() : null : Value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureZoneList.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.IAzureZoneList.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IAzureZoneList FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new AzureZoneList(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureZoneList" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureZoneList" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
