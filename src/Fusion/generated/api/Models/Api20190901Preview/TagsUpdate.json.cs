namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class TagsUpdate
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.ITagsUpdate.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.ITagsUpdate.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.ITagsUpdate FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new TagsUpdate(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="TagsUpdate" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal TagsUpdate(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_tags = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Wandisco.Fusion.Models.Api20190901Preview.TagsUpdateTags.FromJson(__jsonTags) : Tags;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="TagsUpdate" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TagsUpdate" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
