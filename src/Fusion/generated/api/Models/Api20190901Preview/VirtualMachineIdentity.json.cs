namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class VirtualMachineIdentity
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.IVirtualMachineIdentity.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Wandisco.Fusion.Models.Api20190901Preview.IVirtualMachineIdentity.
        /// </returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IVirtualMachineIdentity FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new VirtualMachineIdentity(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="VirtualMachineIdentity" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="VirtualMachineIdentity" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._userAssignedIdentities ? (Wandisco.Fusion.Runtime.Json.JsonNode) this._userAssignedIdentities.ToJson(null,serializationMode) : null, "userAssignedIdentities" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="VirtualMachineIdentity" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal VirtualMachineIdentity(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_userAssignedIdentities = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("userAssignedIdentities"), out var __jsonUserAssignedIdentities) ? Wandisco.Fusion.Models.Api20190901Preview.VirtualMachineIdentityUserAssignedIdentities.FromJson(__jsonUserAssignedIdentities) : UserAssignedIdentities;}
            AfterFromJson(json);
        }
    }
}