namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class NodeDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode"/> into an instance of Wandisco.Fusion.Models.Api20190901Preview.INodeDetails.
        /// </summary>
        /// <param name="node">a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Wandisco.Fusion.Models.Api20190901Preview.INodeDetails.</returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.INodeDetails FromJson(Wandisco.Fusion.Runtime.Json.JsonNode node)
        {
            return node is Wandisco.Fusion.Runtime.Json.JsonObject json ? new NodeDetails(json) : null;
        }

        /// <summary>
        /// Deserializes a Wandisco.Fusion.Runtime.Json.JsonObject into a new instance of <see cref="NodeDetails" />.
        /// </summary>
        /// <param name="json">A Wandisco.Fusion.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal NodeDetails(Wandisco.Fusion.Runtime.Json.JsonObject json)
        {
            ...
            {_fusion = If( json?.PropertyT<Wandisco.Fusion.Runtime.Json.JsonObject>("fusion"), out var __jsonFusion) ? Wandisco.Fusion.Models.Api20190901Preview.NodeDetailsFusion.FromJson(__jsonFusion) : Fusion;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="NodeDetails" /> into a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="NodeDetails" /> as a <see cref="Wandisco.Fusion.Runtime.Json.JsonNode" />.
        /// </returns>
        public Wandisco.Fusion.Runtime.Json.JsonNode ToJson(Wandisco.Fusion.Runtime.Json.JsonObject container, Wandisco.Fusion.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._fusion ? (Wandisco.Fusion.Runtime.Json.JsonNode) this._fusion.ToJson(null,serializationMode) : null, "fusion" ,container.Add );
