namespace Wandisco.Fusion.Models.Api20190901Preview
{
    ...
    public partial class OperationTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Operation" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Wandisco.Fusion.Models.Api20190901Preview.IOperation ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Wandisco.Fusion.Models.Api20190901Preview.IOperation).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
