  ...
  public class ExportPsd1 : PSCmdlet
  {
    ...
    protected override void ProcessRecord()
    {
      try
      {
        ...
        sb.AppendLine($@"{Indent}RootModule = '{"./WanDiscoFusion.psm1"}'");
        ...
        sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/WanDiscoFusion.private.dll"}'");
        ...
        var formatList = customFormatPs1xmlFiles.Prepend("./WanDiscoFusion.format.ps1xml").ToPsList();
