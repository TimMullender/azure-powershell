...
namespace Wandisco.Fusion.Runtime.Json
{
    ...
    {
        internal override object ToValue() => Wandisco.Fusion.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());
