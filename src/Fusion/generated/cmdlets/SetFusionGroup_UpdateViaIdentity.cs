...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"FusionGroup_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetFusionGroup_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="FusionGroup" /> property.</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup _fusionGroup;

        /// <summary>Fusion Group details</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Fusion Group details", ValueFromPipeline = true)]
        [Wandisco.Fusion.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Fusion Group details",
        SerializedName = @"fusionGroup",
        PossibleTypes = new [] { typeof(Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup) })]
        public Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup FusionGroup { get => this._fusionGroup; set => this._fusionGroup = value; }
        ...
        /// <returns>a duplicate instance of SetFusionGroup_UpdateViaIdentity</returns>
        public Wandisco.Fusion.Cmdlets.SetFusionGroup_UpdateViaIdentity Clone()
        {
            var clone = new SetFusionGroup_UpdateViaIdentity();
            ...
            clone.FusionGroup = this.FusionGroup;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FusionGroupsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.FusionGroupName ?? null, FusionGroup, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=FusionGroup})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetFusionGroup_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public SetFusionGroup_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=FusionGroup })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=FusionGroup })
                    {
