...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] FusionGroups_ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Wandisco.Fusion/fusionGroups"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"FusionGroup_List")]
    [global::System.Management.Automation.OutputType(typeof(Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup))]
    [global::Wandisco.Fusion.Description(@"Returns list of fusionGroups under  subscription.")]
    [global::Wandisco.Fusion.Generated]
    public partial class GetFusionGroup_List : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetFusionGroup_List" /> cmdlet class.
        /// </summary>
        public GetFusionGroup_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FusionGroupsListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.FusionGroupsListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
