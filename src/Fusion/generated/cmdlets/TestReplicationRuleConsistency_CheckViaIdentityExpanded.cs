...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ReplicationRules_ConsistencyCheck=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Wandisco.Fusion/fusionGroups/{fusionGroupName}/replicationRules/{replicationRuleName}/consistencyCheck"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"ReplicationRuleConsistency_CheckViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Sample.API.Description(@"Trigger a consistency check on a Replication Rule")]
    [global::Sample.API.Generated]
    public partial class TestReplicationRuleConsistency_CheckViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Sample.API.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConsistencyCheckOptionsBody" /> property.</summary>
        private Sample.API.Models.IConsistencyCheckOptions _consistencyCheckOptionsBody= new Sample.API.Models.ConsistencyCheckOptions();

        /// <summary>Consistency Check Options</summary>
        private Sample.API.Models.IConsistencyCheckOptions ConsistencyCheckOptionsBody { get => this._consistencyCheckOptionsBody; set => this._consistencyCheckOptionsBody = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The threshold of dirty files which will cancel a non-blocking consistency check should it be met")]
        ...
        public int NonBlockingThreshold { get => ConsistencyCheckOptionsBody.NonBlockingThreshold ?? default(int); set => ConsistencyCheckOptionsBody.NonBlockingThreshold = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of check, blocking will prevent client requests while running")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Sample.API.Support.Type))]
        public Sample.API.Support.Type Type { get => ConsistencyCheckOptionsBody.Type ?? ((Sample.API.Support.Type)""); set => ConsistencyCheckOptionsBody.Type = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ReplicationRulesConsistencyCheck' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReplicationRulesConsistencyCheck(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.FusionGroupName ?? null, InputObject.ReplicationRuleName ?? null, ConsistencyCheckOptionsBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ConsistencyCheckOptionsBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestReplicationRuleConsistency_CheckViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public TestReplicationRuleConsistency_CheckViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConsistencyCheckOptionsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConsistencyCheckOptionsBody })
                    {
