...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    [global::Wandisco.Fusion.Description(@"Trigger a consistency check on a Replication Rule")]
        ...
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        private Wandisco.Fusion.Models.Api20190901Preview.IConsistencyCheckOptions _consistencyCheckOptionsBody= new Wandisco.Fusion.Models.Api20190901Preview.ConsistencyCheckOptions();

        /// <summary>Consistency Check Options</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IConsistencyCheckOptions ConsistencyCheckOptionsBody { get => this._consistencyCheckOptionsBody; set => this._consistencyCheckOptionsBody = value; }
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Wandisco.Fusion.Support.Type))]
        public Wandisco.Fusion.Support.Type Type { get => ConsistencyCheckOptionsBody.Type ?? ((Wandisco.Fusion.Support.Type)""); set => ConsistencyCheckOptionsBody.Type = value; }
