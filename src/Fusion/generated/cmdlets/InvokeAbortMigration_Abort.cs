...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Migrations_Abort=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Wandisco.Fusion/fusionGroups/{fusionGroupName}/replicationRules/{replicationRuleName}/migrations/{migrationName}/abort"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AbortMigration_Abort", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Wandisco.Fusion.Description(@"Abort a migration")]
    [global::Wandisco.Fusion.Generated]
    public partial class InvokeAbortMigration_Abort : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAbortMigration_Abort" /> cmdlet class.
        /// </summary>
        public InvokeAbortMigration_Abort()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MigrationsAbort' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MigrationsAbort(ResourceGroupName, SubscriptionId, FusionGroupName, ReplicationRuleName, MigrationName, onOk, onDefault, this, Pipeline);
