...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Migrations_Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Wandisco.Fusion/fusionGroups/{fusionGroupName}/replicationRules/{replicationRuleName}/migrations/{migrationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"Migration_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Wandisco.Fusion.Description(@"Delete a migration")]
    [global::Wandisco.Fusion.Generated]
    public partial class RemoveMigration_Delete : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MigrationsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MigrationsDelete(ResourceGroupName, SubscriptionId, FusionGroupName, ReplicationRuleName, MigrationName, onOk, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveMigration_Delete" /> cmdlet class.
        /// </summary>
        public RemoveMigration_Delete()
        {
