...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Plugins_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Wandisco.Fusion/fusionGroups/{fusionGroupName}/azureZones/{azureZoneName}/plugins/{pluginName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Plugin_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPlugin))]
    [global::Sample.API.Description(@"Creates or updates a Plugin")]
    [global::Sample.API.Generated]
    public partial class SetPlugin_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Sample.API.Runtime.IEventListener
    {
        ...
        public string Location { get => PluginBody.Location ?? null; set => PluginBody.Location = value; }
        ...
        /// <summary>Backing field for <see cref="PluginBody" /> property.</summary>
        private Sample.API.Models.IPlugin _pluginBody= new Sample.API.Models.Plugin();

        /// <summary>Plugin AzureZone subresource</summary>
        private Sample.API.Models.IPlugin PluginBody { get => this._pluginBody; set => this._pluginBody = value; }

        /// <summary>The kind of Plugin.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The kind of Plugin.")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Sample.API.Support.PluginKind))]
        public Sample.API.Support.PluginKind PluginKind { get => PluginBody.PluginKind; set => PluginBody.PluginKind = value; }
        ...
        public Sample.API.Models.IResourceTags Tags { get => PluginBody.Tags ?? null /* object */; set => PluginBody.Tags = value; }
        ...
        /// <returns>a duplicate instance of SetPlugin_UpdateViaIdentityExpanded</returns>
        public Sample.API.Cmdlets.SetPlugin_UpdateViaIdentityExpanded Clone()
        {
            var clone = new SetPlugin_UpdateViaIdentityExpanded();
            ...
            clone.PluginBody = this.PluginBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PluginsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.PluginName)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.PluginName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.PluginsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.FusionGroupName ?? null, InputObject.AzureZoneName ?? null, InputObject.PluginName ?? null, PluginBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PluginBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlugin_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetPlugin_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PluginBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PluginBody })
                    {
