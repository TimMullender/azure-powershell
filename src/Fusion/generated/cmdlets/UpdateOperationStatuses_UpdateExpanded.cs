...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] OperationStatuses_Update=>PATCH:"/providers/Wandisco.Fusion/locations/{locationName}/operationStatuses/{operationStatusId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"OperationStatuses_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus))]
    [global::Wandisco.Fusion.Description(@"Patches a given operationStatus.")]
    [global::Wandisco.Fusion.Generated]
    public partial class UpdateOperationStatuses_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "An invariant error code used for error troubleshooting, aggregation, and analysis.")]
        ...
        public string Code { get => OperationStatusBody.Code ?? null; set => OperationStatusBody.Code = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Operation Id")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id { get => OperationStatusBody.Id ?? null; set => OperationStatusBody.Id = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "An actionable error message indicating what error occurred.")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Message { get => OperationStatusBody.Message ?? null; set => OperationStatusBody.Message = value; }
        ...
        /// <summary>Backing field for <see cref="OperationStatusBody" /> property.</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus _operationStatusBody= new Wandisco.Fusion.Models.Api20190901Preview.OperationStatus();

        /// <summary>operation status object</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus OperationStatusBody { get => this._operationStatusBody; set => this._operationStatusBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The id of the operationStatus")]
        [Wandisco.Fusion.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Status { get => OperationStatusBody.Status ?? null; set => OperationStatusBody.Status = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus" />
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OperationStatusesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OperationStatusesUpdate(LocationName, OperationStatusId, OperationStatusBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  LocationName=LocationName,OperationStatusId=OperationStatusId,body=OperationStatusBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateOperationStatuses_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateOperationStatuses_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { LocationName=LocationName, OperationStatusId=OperationStatusId, body=OperationStatusBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { LocationName=LocationName, OperationStatusId=OperationStatusId, body=OperationStatusBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus
