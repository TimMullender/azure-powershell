...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"OperationStatuses_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateOperationStatuses_Update : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        private Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus _operationStatus;

        /// <summary>operation status object</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "operation status object", ValueFromPipeline = true)]
        [Wandisco.Fusion.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"operation status object",
        SerializedName = @"operationStatus",
        PossibleTypes = new [] { typeof(Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus) })]
        public Wandisco.Fusion.Models.Api20190901Preview.IOperationStatus OperationStatus { get => this._operationStatus; set => this._operationStatus = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OperationStatusesUpdate(LocationName, OperationStatusId, OperationStatus, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  LocationName=LocationName,OperationStatusId=OperationStatusId,body=OperationStatus})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateOperationStatuses_Update" /> cmdlet class.
        /// </summary>
        public UpdateOperationStatuses_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { LocationName=LocationName, OperationStatusId=OperationStatusId, body=OperationStatus })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { LocationName=LocationName, OperationStatusId=OperationStatusId, body=OperationStatus })
                    {
