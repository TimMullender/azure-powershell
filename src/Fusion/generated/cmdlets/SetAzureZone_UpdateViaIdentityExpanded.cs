...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzureZone_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class SetAzureZone_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="AzureZoneBody" /> property.</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IAzureZone _azureZoneBody= new Wandisco.Fusion.Models.Api20190901Preview.AzureZone();

        /// <summary>Azure Zone</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IAzureZone AzureZoneBody { get => this._azureZoneBody; set => this._azureZoneBody = value; }
        ...
        public string Location { get => AzureZoneBody.Location ?? null; set => AzureZoneBody.Location = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of nodes in the zone")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int NodeCount { get => AzureZoneBody.NodeCount ?? default(int); set => AzureZoneBody.NodeCount = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Access Key for storage (use either key or identity)")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StorageAccessKey { get => AzureZoneBody.StorageAccessKey ?? null; set => AzureZoneBody.StorageAccessKey = value; }

        /// <summary>Resource ID of ADLS Gen 2 account to replicate to</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resource ID of ADLS Gen 2 account to replicate to")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StorageAccountId { get => AzureZoneBody.StorageAccountId ?? null; set => AzureZoneBody.StorageAccountId = value; }

        /// <summary>Container to replicate</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Container to replicate")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StorageContainer { get => AzureZoneBody.StorageContainer ?? null; set => AzureZoneBody.StorageContainer = value; }

        /// <summary>The type of identity used for the virtual machine.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of identity used for the virtual machine.")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Wandisco.Fusion.Support.ResourceIdentityType))]
        public Wandisco.Fusion.Support.ResourceIdentityType StorageManagedIdentityType { get => AzureZoneBody.StorageManagedIdentityType ?? ((Wandisco.Fusion.Support.ResourceIdentityType)""); set => AzureZoneBody.StorageManagedIdentityType = value; }
        ...
        public Wandisco.Fusion.Models.Api20190901Preview.IVirtualMachineIdentityUserAssignedIdentities StorageManagedIdentityUserAssignedIdentities { get => AzureZoneBody.StorageManagedIdentityUserAssignedIdentities ?? null /* object */; set => AzureZoneBody.StorageManagedIdentityUserAssignedIdentities = value; }

        /// <summary>Resource ID of Subnet to connect VMs to</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resource ID of Subnet to connect VMs to")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Subnet { get => AzureZoneBody.Subnet ?? null; set => AzureZoneBody.Subnet = value; }
        ...
        public Wandisco.Fusion.Models.Api20190901Preview.IResourceTags Tags { get => AzureZoneBody.Tags ?? null /* object */; set => AzureZoneBody.Tags = value; }

        /// <summary>Size of VM</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Size of VM")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Wandisco.Fusion.Support.VMSize))]
        public Wandisco.Fusion.Support.VMSize VMSize { get => AzureZoneBody.VMSize ?? ((Wandisco.Fusion.Support.VMSize)""); set => AzureZoneBody.VMSize = value; }

        /// <summary>Resource ID of virtual network to attach the VMs to</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resource ID of virtual network to attach the VMs to")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string VirtualNetworkId { get => AzureZoneBody.VirtualNetworkId ?? null; set => AzureZoneBody.VirtualNetworkId = value; }
        ...
        /// <returns>a duplicate instance of SetAzureZone_UpdateViaIdentityExpanded</returns>
        public Wandisco.Fusion.Cmdlets.SetAzureZone_UpdateViaIdentityExpanded Clone()
        {
            var clone = new SetAzureZone_UpdateViaIdentityExpanded();
            ...
            clone.AzureZoneBody = this.AzureZoneBody;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.AzureZoneName)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.AzureZoneName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.AzureZonesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.FusionGroupName ?? null, InputObject.AzureZoneName ?? null, AzureZoneBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=AzureZoneBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzureZone_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetAzureZone_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AzureZoneBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AzureZoneBody })
                    {
