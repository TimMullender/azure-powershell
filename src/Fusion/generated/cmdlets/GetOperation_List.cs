...
namespace Sample.API.Cmdlets
{
    ...
    [global::Sample.API.Description(@"Lists all of the available RP operations.")]
        ...
        Sample.API.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IOperationListResult" /> from the remote call</param>
