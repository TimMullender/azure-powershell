...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] HiveReplicationRules_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Wandisco.Fusion/fusionGroups/{fusionGroupName}/hiveReplicationRules/{hiveReplicationRuleName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"HiveReplicationRule_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRule))]
    [global::Wandisco.Fusion.Description(@"Create or update a hiveReplicationRule")]
    [global::Wandisco.Fusion.Generated]
    public partial class SetHiveReplicationRule_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The simple pattern of the Database as a mapped path determined by Fusion.")]
        ...
        public string DbNamePattern { get => HiveReplicationRuleBody.DbNamePattern ?? null; set => HiveReplicationRuleBody.DbNamePattern = value; }

        /// <summary>Backing field for <see cref="HiveReplicationRuleBody" /> property.</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRule _hiveReplicationRuleBody= new Wandisco.Fusion.Models.Api20190901Preview.HiveReplicationRule();

        /// <summary>Hive Replication Rule</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRule HiveReplicationRuleBody { get => this._hiveReplicationRuleBody; set => this._hiveReplicationRuleBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => HiveReplicationRuleBody.Location ?? null; set => HiveReplicationRuleBody.Location = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of database where consistency check status is CONSISTENT")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public long RecentConsistencyReportConsistent { get => HiveReplicationRuleBody.RecentConsistencyReportConsistent ?? default(long); set => HiveReplicationRuleBody.RecentConsistencyReportConsistent = value; }

        /// <summary>The number of database where consistency check status is FAILED</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of database where consistency check status is FAILED")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(long) })]
        public long RecentConsistencyReportFailed { get => HiveReplicationRuleBody.RecentConsistencyReportFailed ?? default(long); set => HiveReplicationRuleBody.RecentConsistencyReportFailed = value; }

        /// <summary>The number of database where consistency check status is INCONSISTENT</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of database where consistency check status is INCONSISTENT")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(long) })]
        public long RecentConsistencyReportInconsistent { get => HiveReplicationRuleBody.RecentConsistencyReportInconsistent ?? default(long); set => HiveReplicationRuleBody.RecentConsistencyReportInconsistent = value; }

        /// <summary>The number of database where consistency check status is RUNNING</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of database where consistency check status is RUNNING")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(long) })]
        public long RecentConsistencyReportRunning { get => HiveReplicationRuleBody.RecentConsistencyReportRunning ?? default(long); set => HiveReplicationRuleBody.RecentConsistencyReportRunning = value; }

        /// <summary>The number of database where consistency check status is UNKNOWN</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of database where consistency check status is UNKNOWN")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(long) })]
        public long RecentConsistencyReportUnknown { get => HiveReplicationRuleBody.RecentConsistencyReportUnknown ?? default(long); set => HiveReplicationRuleBody.RecentConsistencyReportUnknown = value; }

        /// <summary>The simple pattern of the Table Name as a mapped path as determined by Fusion.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The simple pattern of the Table Name as a mapped path as determined by Fusion.")]
        [global::Wandisco.Fusion.Category(global::Wandisco.Fusion.ParameterCategory.Body)]
        [Wandisco.Fusion.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TableNamePattern { get => HiveReplicationRuleBody.TableNamePattern ?? null; set => HiveReplicationRuleBody.TableNamePattern = value; }
        ...
        public Wandisco.Fusion.Models.Api20190901Preview.IResourceTags Tags { get => HiveReplicationRuleBody.Tags ?? null /* object */; set => HiveReplicationRuleBody.Tags = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRule"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of SetHiveReplicationRule_UpdateViaIdentityExpanded</returns>
        public Wandisco.Fusion.Cmdlets.SetHiveReplicationRule_UpdateViaIdentityExpanded Clone()
        {
            var clone = new SetHiveReplicationRule_UpdateViaIdentityExpanded();
            ...
            clone.HiveReplicationRuleBody = this.HiveReplicationRuleBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'HiveReplicationRulesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.HiveReplicationRuleName)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.HiveReplicationRuleName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.HiveReplicationRulesCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.FusionGroupName ?? null, InputObject.HiveReplicationRuleName ?? null, HiveReplicationRuleBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=HiveReplicationRuleBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetHiveReplicationRule_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetHiveReplicationRule_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=HiveReplicationRuleBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=HiveReplicationRuleBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRule> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Wandisco.Fusion.Models.Api20190901Preview.IHiveReplicationRule
