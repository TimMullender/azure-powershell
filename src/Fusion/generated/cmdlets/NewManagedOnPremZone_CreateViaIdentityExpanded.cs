...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ManagedOnPremZones_CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Wandisco.Fusion/fusionGroups/{fusionGroupName}/managedOnPremZones/{managedOnPremZoneName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"ManagedOnPremZone_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IManagedOnPremZone))]
    [global::Sample.API.Description(@"Creates a managed OnPremZone.")]
    [global::Sample.API.Generated]
    public partial class NewManagedOnPremZone_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Sample.API.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The deployment type of the Managed OnPrem zone")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Sample.API.Support.ManagedOnPremDeploymentType))]
        public Sample.API.Support.ManagedOnPremDeploymentType DeploymentType { get => ManagedOnPremZoneBody.DeploymentType; set => ManagedOnPremZoneBody.DeploymentType = value; }

        /// <summary>The external IP of the managed OnPrem fusion server</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The external IP of the managed OnPrem fusion server")]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ExternalIP { get => ManagedOnPremZoneBody.ExternalIP ?? null; set => ManagedOnPremZoneBody.ExternalIP = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => ManagedOnPremZoneBody.Location ?? null; set => ManagedOnPremZoneBody.Location = value; }

        /// <summary>Backing field for <see cref="ManagedOnPremZoneBody" /> property.</summary>
        private Sample.API.Models.IManagedOnPremZone _managedOnPremZoneBody= new Sample.API.Models.ManagedOnPremZone();

        /// <summary>Managed OnPrem Zone</summary>
        private Sample.API.Models.IManagedOnPremZone ManagedOnPremZoneBody { get => this._managedOnPremZoneBody; set => this._managedOnPremZoneBody = value; }
        ...
        public Sample.API.Models.IResourceTags Tags { get => ManagedOnPremZoneBody.Tags ?? null /* object */; set => ManagedOnPremZoneBody.Tags = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IManagedOnPremZone" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IManagedOnPremZone> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewManagedOnPremZone_CreateViaIdentityExpanded</returns>
        public Sample.API.Cmdlets.NewManagedOnPremZone_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewManagedOnPremZone_CreateViaIdentityExpanded();
            ...
            clone.ManagedOnPremZoneBody = this.ManagedOnPremZoneBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewManagedOnPremZone_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewManagedOnPremZone_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedOnPremZonesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.ManagedOnPremZoneName)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ManagedOnPremZoneName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.ManagedOnPremZonesCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.FusionGroupName ?? null, InputObject.ManagedOnPremZoneName ?? null, ManagedOnPremZoneBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ManagedOnPremZoneBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ManagedOnPremZoneBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ManagedOnPremZoneBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IManagedOnPremZone> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IManagedOnPremZone
