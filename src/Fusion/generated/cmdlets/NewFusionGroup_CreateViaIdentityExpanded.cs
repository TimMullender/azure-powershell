...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"FusionGroup_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup))]
    [global::Wandisco.Fusion.Description(@"Create or update fusionGroup resource.")]
    [global::Wandisco.Fusion.Generated]
    public partial class NewFusionGroup_CreateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        private Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup _fusionGroupBody= new Wandisco.Fusion.Models.Api20190901Preview.FusionGroup();

        /// <summary>Fusion Group details</summary>
        private Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup FusionGroupBody { get => this._fusionGroupBody; set => this._fusionGroupBody = value; }
        ...
        public Wandisco.Fusion.Models.Api20190901Preview.IErrorDefinition[] HealthStatusDetails { get => FusionGroupBody.HealthStatusDetails ?? null /* arrayOf */; set => FusionGroupBody.HealthStatusDetails = value; }
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Wandisco.Fusion.Support.HealthStatusSummary))]
        public Wandisco.Fusion.Support.HealthStatusSummary PropertiesHealthStatusStatus { get => FusionGroupBody.PropertiesHealthStatusStatus ?? ((Wandisco.Fusion.Support.HealthStatusSummary)""); set => FusionGroupBody.PropertiesHealthStatusStatus = value; }
        ...
        public Wandisco.Fusion.Models.Api20190901Preview.IResourceTags Tags { get => FusionGroupBody.Tags ?? null /* object */; set => FusionGroupBody.Tags = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup" /> from
        /// the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewFusionGroup_CreateViaIdentityExpanded</returns>
        public Wandisco.Fusion.Cmdlets.NewFusionGroup_CreateViaIdentityExpanded Clone()
        {
            var clone = new NewFusionGroup_CreateViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewFusionGroup_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewFusionGroup_CreateViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FusionGroupsCreateOrUpdate(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.FusionGroupName ?? null, FusionGroupBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=FusionGroupBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=FusionGroupBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=FusionGroupBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Wandisco.Fusion.Models.Api20190901Preview.IFusionGroup
