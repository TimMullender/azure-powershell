...
namespace Wandisco.Fusion.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Plugins_Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Wandisco.Fusion/fusionGroups/{fusionGroupName}/azureZones/{azureZoneName}/plugins/{pluginName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"Plugin_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Wandisco.Fusion.Description(@"Deletes a given Plugin.")]
    [global::Wandisco.Fusion.Generated]
    public partial class RemovePlugin_Delete : global::System.Management.Automation.PSCmdlet,
        Wandisco.Fusion.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemovePlugin_Delete</returns>
        public Wandisco.Fusion.Cmdlets.RemovePlugin_Delete Clone()
        {
            var clone = new RemovePlugin_Delete();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PluginsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PluginsDelete(ResourceGroupName, SubscriptionId, FusionGroupName, AzureZoneName, PluginName, onOk, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemovePlugin_Delete" /> cmdlet class.
        /// </summary>
        public RemovePlugin_Delete()
        {
